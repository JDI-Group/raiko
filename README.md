...
```shell
./script/prove-block.sh moonchain_hudson native 10
```
...
```shell
./script/prove-block.sh moonchain_hudson native sync
```
...
./script/prove-block.sh moonchain_hudson risc0-bonsai 10
```
