...
This step will interact with a L1 contract, means BNB Smart Chain Mainnet for Moonchain Mainnet and BNB Smart Chain Testnet for Moonchain Hudson Testnet. You will need some BNB on BSC side to complete the process.
...
mkdir -p ~/moonchain
cd ~/moonchain
git clone https://github.com/JDI-Group/moonchain-mono.git -b moonchain-dev
cd mxc-mono
git submodule init
...
For Moonchain Hudson Testnet.

```
SGX_VERIFIER_ADDRESS=0x61db964133eE38357b828607957f88be35c06Fcd ATTESTATION_ADDRESS=0x49D9D5dF36763Cb5DEBEd993c8C3Ac1088EbCD14 PEM_CERTCHAIN_ADDRESS=0x530923f29cb7A71f291056817f6C413C256Fe56a
```
...
export FORK_URL=https://data-seed-prebsc-1-s1.bnbchain.org:8545
...
```
export PRIVATE_KEY=<YOUR PRIVATE KEY with leading 0x>
export FORK_URL=https://bsc-dataseed.bnbchain.org
./script/config_dcap_sgx_verifier.sh --quote <QUOTE FROM raiko INIT>
```
...
export L1_NETWORK="bsc_testnet"
export NETWORK="moonchain_hudson"
